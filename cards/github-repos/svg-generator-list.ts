...
<svg xmlns="http://www.w3.org/2000/svg" width="600" height="600" viewBox="0 0 600 600">
  ...
  <rect width="600" height="600" fill="transparent" rx="20"/>
  ...
  <!-- Bottom flame border -->
  <rect x="20.5" y="569.5" width="559" height="25" fill="url(#fireGradient)" filter="url(#flameWave)">
    <animateTransform attributeName="transform" type="translate" values="0 0;0 5;0 0" dur="2s" repeatCount="indefinite"/>
  </rect>
  <!-- Left flame border -->
  <rect x="20.5" y="5.5" width="25" height="589" fill="url(#fireGradient)" filter="url(#flameWave)">
    <animateTransform attributeName="transform" type="translate" values="0 0;-5 0;0 0" dur="2s" repeatCount="indefinite"/>
  </rect>
  <!-- Right flame border -->
  <rect x="554.5" y="5.5" width="25" height="589" fill="url(#fireGradient)" filter="url(#flameWave)">
    <animateTransform attributeName="transform" type="translate" values="0 0;5 0;0 0" dur="2s" repeatCount="indefinite"/>
  </rect>
  ...
  <g fill="yellow" opacity="0.5">
    ...
    <circle cx="450" cy="584.5" r="1.5">
      <animate attributeName="cy" values="584.5;564.5" dur="2s" repeatCount="indefinite"/>
...
`
  ...
  <line x1="575" y1="360" x2="575" y2="410" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="575" y1="410" x2="575" y2="440" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="575" y1="440" x2="575" y2="470" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="575" y1="470" x2="575" y2="500" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="575" y1="500" x2="575" y2="530" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="575" y1="530" x2="575" y2="560" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="575" y1="560" x2="575" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  
  <!-- Bottom segments -->
  <line x1="575" y1="590" x2="525" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="525" y1="590" x2="475" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="475" y1="590" x2="425" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="425" y1="590" x2="375" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="375" y1="590" x2="325" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="325" y1="590" x2="275" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="275" y1="590" x2="225" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="225" y1="590" x2="175" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="175" y1="590" x2="125" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="125" y1="590" x2="75" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="75" y1="590" x2="25" y2="590" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  
  <!-- Left segments -->
  <line x1="25" y1="590" x2="25" y2="540" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="25" y1="540" x2="25" y2="490" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="25" y1="490" x2="25" y2="440" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
  <line x1="25" y1="440" x2="25" y2="390" stroke-width="8" class="led-segment ${theme}" filter="url(#neonGlow)"/>
    ...
    ${
      reposToShow.length > 0
        ...
        <g transform="translate(0, ${index * 40})">
          <!-- Repository Card -->
          <rect x="0" y="0" width="520" height="30" fill="${
            currentTheme.cardBg
          }" rx="6" stroke="${currentTheme.border}" stroke-width="1"/>
          
          <!-- Repository Icon -->    
          <text x="18" y="20" font-family="system-ui, -apple-system, sans-serif" font-size="14" fill="white" text-anchor="middle">📁</text>
          
          <!-- Repository Name -->
          <text x="35" y="15" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="${
            currentTheme.primary
          }">
          ...
          <text x="35" y="26" font-family="system-ui, -apple-system, sans-serif" font-size="10" fill="${
            currentTheme.text
          }">
        ...
        <!-- Language -->
        <circle cx="380" cy="15" r="4" fill="${getLanguageColor(
          repo.language
        )}"/>
        <text x="390" y="18" font-family="system-ui, -apple-system, sans-serif" font-size="10" fill="${
          currentTheme.text
        }">
          ${repo.language}
        </text>
        ...
        <!-- Stars -->
        <text x="450" y="13" font-family="system-ui, -apple-system, sans-serif" font-size="10" fill="${
          currentTheme.text
        }">
        ...
        <!-- Forks -->
        <text x="450" y="26" font-family="system-ui, -apple-system, sans-serif" font-size="10" fill="${
          currentTheme.text
        }">
    ...
    ${
      topRepos.length > 0
        ...
        <g transform="translate(0, ${index * 150})">
          <!-- Repository Card - Better organized with more height -->
          <rect x="0" y="0" width="520" height="140" fill="${
            currentTheme.cardBg
          }" rx="10" stroke="${
                currentTheme.border
          ...
          <text x="75" y="28" font-family="system-ui, -apple-system, sans-serif" font-size="16" font-weight="700" fill="${
            ...
            ${truncateText(repo.name.split("/").pop() || repo.name, 40)}
          </text>
          
          <!-- Repository Description - Multi-line with proper wrapping and better spacing -->
          ${wrapText(repo.description, 55, 6)
            .map(
              (line, lineIndex) => `
            <text x="75" y="${
              50 + lineIndex * 14
          ...
          <g transform="translate(75, 125)">
            ...
            <text x="12" y="6" font-family="system-ui, -apple-system, sans-serif" font-size="12" fill="${
              currentTheme.text
            }" opacity="0.8">
              ${repo.language}
            </text>
          ...
          <g transform="translate(400, 28)">
            ...
            <!-- Forks -->
            <text x="0" y="16" font-family="system-ui, -apple-system, sans-serif" font-size="12" fill="${
              currentTheme.text
            }" opacity="0.9">
              🍴 ${formatNumber(repo.forks)}
            </text>
